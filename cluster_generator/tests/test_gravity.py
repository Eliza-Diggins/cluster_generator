...
class ConstructorQUMOND(Constructor):
    """Constructor class for the AQUAL tests"""
...
class TestQUMOND(GravityTest):
    constructor_class = ConstructorQUMOND
    gravity_class = QUMOND
    ...
    def check_dynamical_mass(
        ...
        if sub_method == 1 and is_asymptotic:
            ...
            u = beta / (fields["radius"] ** 2 * cls.gravity_class.get_a0())
