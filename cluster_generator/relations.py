...
from cluster_generator.utilities.types import MaybeUnitScalar, ensure_ytquantity


def f_gas(m500: MaybeUnitScalar, hubble: float = 0.7) -> float:
    r"""
...
def m_bcg(m500: MaybeUnitScalar) -> unyt.unyt_quantity:
...
def m_sat(m500: MaybeUnitScalar) -> unyt.unyt_quantity:
...
def r_bcg(r200: MaybeUnitScalar) -> unyt.unyt_quantity:
...
def convert_ne_to_density(ne: MaybeUnitScalar) -> unyt.unyt_quantity:
