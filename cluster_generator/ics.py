...
Notes
-----
The :py:class:`ClusterICs` class allows for the combination of individual :py:class:`model.ClusterModel` instances
...
class ClusterICs:
    ...
    def add_black_holes(
        ...
        bh_mass: list[unyt_array] | unyt_array,
        pos: list[unyt_array] | unyt_array = None,
        vel: list[unyt_array] | unyt_array = None,
    ...
    @classmethod
    def from_file(cls, filename: str | Path) -> "ClusterICs":
    ...
    def setup_particle_ics(
        self, regenerate_particles: bool = False, prng: int = None
    ) -> ClusterParticles:
        ...
        models = [ClusterModel.from_h5_file(str(hf)) for hf in self.models]
